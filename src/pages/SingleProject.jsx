    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0A151E] via-[#0D1B2A] to-[#0A151E] flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">{t("project_not_found")}</h2>
          <p className="text-gray-400 mb-8 max-w-md mx-auto">{t("project_not_found_desc")}</p>
          <button
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          >
            ...
            <span className="font-medium">{t("back_to_projects")}</span>
          </button>
        </div>
        ...
        {project.featured && (
          <div className="text-center mb-6">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-yellow-600/20 to-orange-600/20 border border-yellow-500/30 rounded-2xl px-6 py-3">
              ...
              <span className="text-yellow-300 font-semibold">{t("featured_project")}</span>
            </div>
          </div>
        )}
        ...
        <div className="bg-gradient-to-br from-[#192630] to-[#1a2332] rounded-2xl p-8 mb-8 border border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 pt-8 border-t border-gray-600">
            <div className="text-center">
              <h3 className="text-gray-400 text-sm font-medium mb-2">{t("contract_address")}</h3>
            ...
            <div className="text-center">
              <h3 className="text-gray-400 text-sm font-medium mb-2">{t("creator")}</h3>
            ...
            <div className="text-center">
              <h3 className="text-gray-400 text-sm font-medium mb-2">{t("launch_date")}</h3>
