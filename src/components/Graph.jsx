    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800/60 shrink-0">
                ...
                <h2 className="text-white font-bold tracking-widest text-sm uppercase absolute left-1/2 -translate-x-1/2 hidden md:block">
                    Insider Networks
                </h2>
            ...
            <div className="flex flex-1 overflow-hidden relative">
                {/* ── LEFT: Node Legend ── */}
                <div
                    className="w-72 shrink-0 border-r border-gray-800/60 overflow-y-auto"
                ...
                >
                    ...
                    {selectedNode && (
                        <div
                            className="absolute bottom-6 left-6 w-80 rounded-2xl border border-gray-700/60 p-4 shadow-2xl"
